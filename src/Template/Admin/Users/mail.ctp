<div id="page-content">
    <div class="panel">
        <div class="panel-body">
            <!-- GENERAL -->
            <!--===================================================-->
            <h3 class="pad-all bord-btm text-thin">Bonjour <?= $first_name.' '.$first_name ?></h3>
                ...
                <div class="bord-no pad-top">
                    ...
                    <div id="demo-gen-faq1" class="collapse in">
                        ...
                        <div class="cls-content-sm" style="min-width: 210px;">
                            <a href="<?= $this->Url->Build(['controller'=>'Users', 'action' => 'active',md5($password) ],true) ?>" class="btn btn-primary btn-lg btn-block" type="button" >
